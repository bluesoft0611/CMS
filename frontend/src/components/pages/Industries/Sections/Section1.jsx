...
export default function Section1() {
  ...
  return (
    <div className="max-layout-container px-4 lg:px-16 py-16 lg:h-[770px] flex justify-center items-center">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-10">
        <div className="order-2 lg:order-1">
          ...
          {page?.description?.split("\n").map((para, idx) => (
            <p
              key={idx}
              className="font-nunito text-[16px] font-normal leading-6 tracking-normal align-middle mt-4"
            >
              {para}
            </p>
          ))}
        ...
        <div className="order-1 lg:order-2">
          <img
            ...
            className="w-full lg:w-[560px] h-auto lg:h-[539px] rounded-sm shadow-md"
          />
        </div>
      </div>
    </div>
