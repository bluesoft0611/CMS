...
export default function NavBar() {
  ...
  // Fetch the data of slug when component render
  useEffect(() => {
  ...
  return (
    <div className="border-b relative z-40 bg-white">
...
function SubNav({ type, content }) {
  return (
    <div className="absolute left-0 top-full bg-white shadow-xl p-6 z-50 w-screen border-t-2 border-primary">
