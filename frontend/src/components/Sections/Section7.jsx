...
const Section7 = () => {
  ...
  return (
    <div className="container mx-auto px-4 lg:px-16 py-12 h-[750px] flex flex-col justify-center">
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
        <div className="mr-16">
          <h6 className="text-sm text-gray-500 uppercase mb-2">
            {page?.title}
          </h6>
          <p class="font-nunito font-medium text-2xl leading-[40px] tracking-normal text-primary">
            {page?.subTitle}
          </p>
          ...
          <div className="space-y-8 mt-12">
            {page?.cards?.map((card, index) => (
              ...
              >
                <img src={`${baseURL}${card?.icon?.url}`} alt="Icon" className="w-8 h-8 mt-1" />
                <div>
