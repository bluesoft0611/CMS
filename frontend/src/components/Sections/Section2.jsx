  ...
  return (
    <div className="slider-container bg-primary h-[866px] flex flex-col justify-center">
            ...
            <div class="relative">
                <Swiper
                    ...
                    {page?.cards?.map((slide, index) => (
                        <SwiperSlide key={index} style={{ width: "65%", marginRight: "20px" }}>
        ...
        <div className="section2 flex justify-end space-x-4 mt-4">
            <div className="swiper-button-prev bg-gray-200 px-4 py-2 rounded-lg cursor-pointer">
            </div>
            <div className="swiper-button-next bg-gray-200 px-4 py-2 rounded-lg cursor-pointer">
            </div>
        </div>
        </div>
    </div>
