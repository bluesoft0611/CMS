...
const Section8 = () => {
  ...
  return (
    <div className="slider-container bg-[#F5F5F5] h-[986px] flex flex-col justify-center">
      <p class="font-nunito font-normal text-lg leading-6 tracking-normal text-center uppercase text-[#4F565E]">
        {page?.title}
      </p>
      <p class="font-nunito font-medium text-[30px] leading-[40px] tracking-normal text-center text-primary max-w-[754px] mx-auto mt-5">
        {page?.subTitle}
      </p>
      <p class="font-dm font-normal text-xl leading-[30px] tracking-normal mt-5 max-w-[80%] mx-auto mb-14">
        {page?.description}
      </p>
        ...
        >
          {page?.cards?.map((slide, index) => (
            <SwiperSlide key={index}>
              <div className="flex bg-white p-10 shadow-lg h-[433px]">
                <div className="pr-4 flex flex-col justify-between h-full">
                  <div className="flex flex-col items-start">
                    <img src={`${baseURL}${slide?.icon?.url}`} alt="Icon" className="w-4 h-4 mb-4" />
